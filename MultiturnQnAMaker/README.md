...
_ **Important!!!!**  The Virtual Assistant Template and bot framework tools have not yet been updated to respect 
...
updated with the proper instructions on how to incorporate follow-on prompts in an assistant._
